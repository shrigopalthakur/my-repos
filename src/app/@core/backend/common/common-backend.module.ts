...
import { ThirdPartyApplicationsApi } from './api/thirdPartyApplications.api';
import { RegisterUserApi } from './api/registerUser.api';
import { ApplicationProcessApi } from './api/applicationProcess.api';

const API = [
  ApplicationApi,
  ThirdPartyApplicationsApi,
  UsersApi,
  CountriesApi, 
  SettingsApi,
  RegisterUserApi,
